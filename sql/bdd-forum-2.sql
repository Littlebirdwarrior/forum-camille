...
-- Listage de la structure de la base pour forum_cd_2
CREATE DATABASE IF NOT EXISTS `forum_cd_2` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `forum_cd_2`;

-- Listage de la structure de la table forum_cd_2. category
...
-- Listage des données de la table forum_cd_2.category : ~1 rows (environ)
/*!40000 ALTER TABLE `category` DISABLE KEYS */;
INSERT INTO `category` (`id_category`, `name`) VALUES
	(1, 'Éducation d’un chiot');
/*!40000 ALTER TABLE `category` ENABLE KEYS */;

-- Listage de la structure de la table forum_cd_2. post
...
-- Listage des données de la table forum_cd_2.post : ~2 rows (environ)
...
-- Listage de la structure de la table forum_cd_2. topic
...
-- Listage des données de la table forum_cd_2.topic : ~1 rows (environ)
...
-- Listage de la structure de la table forum_cd_2. user
...
-- Listage des données de la table forum_cd_2.user : ~2 rows (environ)
